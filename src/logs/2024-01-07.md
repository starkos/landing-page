...
- Threw together [a little executable](https://github.com/starkos/industrious-starter/tree/draft/initial) to bootstrap new multi-platform .NET solutions to my preferences so I can easily spin up new prototypes and playgrounds for ideas. Yeah, I wrote [Premake](https://premake.github.io) but if I start looking at that I know I'll get all sucked in and I have other things I want to explore first.
